...
|**LTS**|Bleeding Edge|
|:---:|:---:|
|[![Travis CI build](https://api.travis-ci.org/pluginsGLPI/useditemsexport.svg?branch=master)](https://travis-ci.org/pluginsGLPI/useditemsexport/)|[![Travis CI build](https://api.travis-ci.org/pluginsGLPI/useditemsexport.svg?branch=develop)](https://travis-ci.org/pluginsGLPI/useditemsexport/)|
