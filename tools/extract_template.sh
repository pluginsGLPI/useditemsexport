...
xgettext *.php */*.php */*.php --copyright-holder='TECLIB' --package-name='GLPI - Used items export' --package-version='1.0.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
